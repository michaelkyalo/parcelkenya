...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes pulse {
    0%,100% { box-shadow: 0 0 8px var(--gold), 0 0 18px rgba(245,166,35,.3); }
    50%     { box-shadow: 0 0 18px var(--gold), 0 0 36px rgba(245,166,35,.55); }
  }
  @keyframes float {
  ...
  .lp-nav-logo {
    ...
    letter-spacing: -.4px; color: var(--w); text-decoration: none;
    flex-shrink: 0;
  }
  .lp-nav-dot {
  ...
  .lp-nav-links {
    display: flex; gap: 30px; margin: 0 auto;
    font-size: .84rem; color: var(--w40);
  }
  ...
  .btn-ghost {
    ...
    border: 1px solid var(--bord2); padding: 7px 18px; border-radius: 9px;
    transition: all .2s;
  }
  ...
  .btn-gold {
    ...
    box-shadow: 0 4px 18px rgba(245,166,35,.28);
  }
  .btn-gold:hover { background: var(--gold2); transform: translateY(-1px); box-shadow: 0 8px 28px rgba(245,166,35,.4); }
  .btn-gold-lg {
    font-family: var(--sans); font-size: .97rem; font-weight: 700; cursor: pointer;
    color: #000; background: var(--gold); border: none;
    padding: 15px 36px; border-radius: 11px;
    transition: all .3s var(--ease);
    box-shadow: 0 8px 32px rgba(245,166,35,.32);
    white-space: nowrap;
  }
  .btn-gold-lg:hover { background: var(--gold2); transform: translateY(-2px); box-shadow: 0 16px 48px rgba(245,166,35,.45); }
  .btn-outline-lg {
    font-family: var(--sans); font-size: .97rem; font-weight: 500; cursor: pointer;
    color: var(--w70); background: var(--w08);
    border: 1px solid var(--bord2); padding: 15px 36px; border-radius: 11px;
  ...
  .lp-hero-orb-a {
    ...
    background: radial-gradient(circle, rgba(245,166,35,.11) 0%, transparent 65%);
    top: -250px; right: -150px; filter: blur(70px);
  ...
  .lp-hero-badge {
    ...
    font-family: var(--mono); font-size: .67rem; letter-spacing: 1.8px;
    color: var(--gold); text-transform: uppercase;
    border: 1px solid rgba(245,166,35,.3); background: rgba(245,166,35,.06);
  ...
  .lp-hero-p {
    font-size: 1.02rem; font-weight: 300; line-height: 1.88; color: var(--w40);
  ...
  .lp-hero-face {
    ...
    font-size: 12px; margin-left: -6px; background: var(--surface);
  }
  ...
  .lp-fc-main {
    ...
    z-index: 10; background: linear-gradient(145deg,#1c2334,#161b27);
    border-color: rgba(245,166,35,.22);
    box-shadow: 0 32px 80px rgba(0,0,0,.65), 0 0 0 1px rgba(245,166,35,.07), 0 0 60px rgba(245,166,35,.06);
    animation: fcMain 6s ease-in-out infinite;
  }
  .lp-fc-status {
    width: 205px; top: 4px; right: -20px; z-index: 8;
    animation: fcStatus 7s .6s ease-in-out infinite;
  }
  .lp-fc-rider {
    width: 225px; bottom: 28px; left: -44px; z-index: 9;
    animation: fcRider 8s 1.2s ease-in-out infinite;
  }
  .lp-fc-notif {
    width: 190px; top: 64px; left: -52px; z-index: 7; padding: 12px 15px;
    animation: fcNotif 5.5s .4s ease-in-out infinite;
  }
  ...
  .fc-pill {
    ...
    font-family:var(--mono); font-size:.62rem; letter-spacing:.5px;
  ...
  .fc-picked   { background:rgba(168,155,255,.1); color:#A89BFF;    border:1px solid rgba(168,155,255,.25); }
  ...
  .fc-avatar {
    ...
    display:flex; align-items:center; justify-content:center;
    font-family:var(--disp); font-size:.68rem; font-weight:800; color:var(--gold);
  }
  ...
  .lp-ticker-item {
    display:inline-flex; align-items:center; gap:8px;
    padding:0 28px; font-size:.78rem; color:var(--w40); white-space:nowrap;
  ...
  .lp-metric-num {
    ...
    letter-spacing:-1.2px; color:var(--w); margin-bottom:4px; line-height:1;
  }
  .lp-metric-num span { color:var(--gold); }
  ...
  .lp-how-steps::before {
    ...
    background:linear-gradient(90deg,transparent,var(--bord2) 20%,var(--bord2) 80%,transparent);
  }
  ...
  .lp-srv-grid {
    ...
    background:var(--border); border:1px solid var(--border); border-radius:22px; overflow:hidden;
  }
  .lp-srv {
    background:var(--bg2); padding:38px 34px;
    transition:background .3s var(--ease); cursor:default; position:relative; overflow:hidden;
  }
  .lp-srv::after {
  ...
  .lp-testi-av {
    ...
    display:flex; align-items:center; justify-content:center;
    font-family:var(--disp); font-size:.75rem; font-weight:800;
  }
  ...
  .lp-faq-q {
    ...
    font-size:.95rem; font-weight:500; color:var(--w); transition:color .2s;
  }
  ...
  .lp-faq-icon {
    ...
    display:flex; align-items:center; justify-content:center;
    font-size:14px; color:var(--w40); transition:all .25s;
  }
  .lp-faq-item.open .lp-faq-icon { background:rgba(245,166,35,.1); border-color:rgba(245,166,35,.25); color:var(--gold); }
  .lp-faq-a {
    font-size:.875rem; color:var(--w40); line-height:1.8; font-weight:300;
  ...
  .lp-footer-social-btn {
    ...
    background:var(--w08); border:1px solid var(--border);
    display:flex; align-items:center; justify-content:center;
    font-size:.85rem; cursor:pointer; transition:all .2s; color:var(--w40);
  }
    ...
    <div className="lp">
        ...
        <div className="lp-ticker-track">
          {[...TICKER, ...TICKER].map((t, i) => (
            <span className="lp-ticker-item" key={i}>
              ...
              {t.split(" ").slice(0,1).map(id => <span className="lp-ticker-val" key={id}>{id}</span>)}
              {" "}{t.split(" ").slice(1).join(" ")}
              <span className="lp-ticker-sep" style={{marginLeft:20}}>·</span>
            </span>
          ))}
        </div>
      </div>
      ...
      <div className="lp-metrics">
        <div className="lp-metrics-inner">
          {[
            { target:47,    suffix:"",   label:"Counties Covered",     chg:"↑ All 47 active", up:true },
            { target:1200,  suffix:"K+", label:"Parcels Delivered",    chg:"↑ +18% this month", up:true },
            { target:98.4,  suffix:"%",  label:"On-time Rate",         chg:"↑ +0.2% vs last month", up:true },
            { target:18,    suffix:"K+", label:"Happy Customers",      chg:"↑ Growing daily", up:true },
          ].map((m,i) => (
            <div className="lp-metric" key={i}>
              ...
              <div className={`lp-metric-chg ${m.up?"up":"dn"}`}>{m.chg}</div>
            </div>
          ))}
        </div>
      </div>
...
<section className="lp-services" id="services">
  <div className="lp-inner">
    <div className="lp-services-header">
      ...
      <h2 className="lp-h2">
        Built for <em>Kenya's terrain</em>
      </h2>

      <p className="lp-sub" style={{marginTop:12}}>
        Six delivery tiers engineered around how Kenyan commerce actually moves — not copy-pasted from overseas logistics.
      </p>
    </div>
    ...
    <div className="lp-srv-grid">
      {[
        {
          ...
          desc: "Same-day within Nairobi & major towns. Guaranteed before 6 pm.",
          tag: "< 6 hrs"
        },
        {
          icon: "🗺️",
          title: "Countrywide",
          desc: "1–3 day delivery to all 47 counties — including remote upcountry regions.",
          tag: "1–3 days"
        },
        {
          icon: "📦",
          title: "Bulk & Business",
          desc: "Volume discounts, SLA guarantees, and full API integration for e-commerce.",
          tag: "Custom rates"
        },
        {
          icon: "🔒",
          title: "Insured Parcels",
          desc: "Optional cover up to KSh 100,000 for high-value or fragile items.",
          tag: "Optional"
        },
        {
          icon: "❄️",
          title: "Fragile & Special",
          desc: "White-glove handling, reinforced packaging — perfect for electronics & glass.",
          tag: "Special care"
        },
        {
          icon: "📱",
          title: "Real-time Tracking",
          desc: "SMS + WhatsApp + app updates at every checkpoint. Know exactly where it is.",
          tag: "Live GPS"
        },
      ].map((s) => (
        <div className="lp-srv" key={s.title}>
      ...
      <section className="lp-testimonials">
        <div className="lp-inner">
          ...
          <div className="lp-testi-grid">
            {[
              {av:"AW", cls:"a", stars:"★★★★★", text:"I run an online boutique in Nairobi and ship to 12 counties weekly. SpeedPak cut my delivery complaints by 90%. The tracking alone is worth it.", name:"Amina Wanjiku", role:"Founder, StyleAfrica"},
      ...
      <footer className="lp-footer">
        <div className="lp-footer-top">
          <div>
            ...
            <div className="lp-footer-social">
              {["𝕏","in","▶","📘"].map(s => (
                <div className="lp-footer-social-btn" key={s}>{s}</div>
              ))}
            </div>
          </div>
          {[
        ...
        <div className="lp-footer-bottom">
          <div className="lp-footer-copy">© 2025 SpeedPak Kenya Ltd · All 47 Counties · Nairobi HQ</div>
