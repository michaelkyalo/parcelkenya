      ...
      <section className="lp-services" id="section-services">
        <div className="lp-inner">
          <div className="lp-services-header">
            ...
            <p className="lp-sub" style={{marginTop:12}}>Six delivery tiers engineered around how Kenyan commerce actually moves — not copy-pasted from overseas logistics.</p>
          </div>
          <div className="lp-srv-grid">
            {[
              ...
              {icon:"❄️", title:"Fragile & Special",  desc:"White-glove handling, reinforced packaging — perfect for electronics & glass.",    tag:"Special care"},
